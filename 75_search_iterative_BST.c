...
int main()
{
    ...
    // calling search element function // iterative search function
    struct node *n = searchIter(p, 3); // searching element iteratevly
    if (n != NULL)
    {
        printf("Found: %d\n", n->data);
    }
    ...
    {
        printf("element not found! %d doesn't exist in BST");
    }
